package com.fragmentapp.contacts.partgroup;
...
public class PartAdapter extends BaseMultiItemQuickAdapter<MultiItemEntity, BaseViewHolder> {
     ...
     */
    public PartAdapter(List<MultiItemEntity> data) {
        super(data);
