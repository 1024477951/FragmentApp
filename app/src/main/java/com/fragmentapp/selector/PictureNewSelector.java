...
public class PictureNewSelector {

    private final WeakReference<Activity> mActivity;
    private final WeakReference<Fragment> mFragment;

    private PictureNewSelector(Activity activity) {
        this(activity, null);
    }

    private PictureNewSelector(Fragment fragment) {
        this(fragment.getActivity(), fragment);
    }

    private PictureNewSelector(Activity activity, Fragment fragment) {
     ...
     */
    public static PictureNewSelector create(AppCompatActivity activity) {
        return new PictureNewSelector(activity);
    }
     ...
     * @return PictureSelector instance.
     */
    public static PictureNewSelector create(Fragment fragment) {
        return new PictureNewSelector(fragment);
    }
     ...
     */
    public PictureNewModel openGallery(int mimeType) {
        return new PictureNewModel(this, mimeType);
    }
     ...
     * @return LocalMedia PictureSelectionModel
     */
    public PictureNewModel openCamera(int mimeType) {
        return new PictureNewModel(this, mimeType, true);
    }
     ...
     * @return
     */
    public PictureNewModel themeStyle(int themeStyle) {
        return new PictureNewModel(this, PictureMimeType.ofImage()).theme(themeStyle);
    }
