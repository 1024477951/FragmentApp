...
public class PictureNewModel {

    private PictureSelectionConfig selectionConfig;
    private PictureNewSelector selector;

    public PictureNewModel(PictureNewSelector selector, int mimeType) {
        this.selector = selector;
        selectionConfig = PictureSelectionConfig.getCleanInstance();
        selectionConfig.mimeType = mimeType;
    }

    public PictureNewModel(PictureNewSelector selector, int mimeType, boolean camera) {
        this.selector = selector;
        selectionConfig = PictureSelectionConfig.getCleanInstance();
     ...
     * @return
     */
    public PictureNewModel theme(@StyleRes int themeStyleId) {
     ...
     * @return
     */
    public PictureNewModel selectionMode(int selectionMode) {
     ...
     * @return
     */
    public PictureNewModel enableCrop(boolean enableCrop) {
     ...
     * @return
     */
    public PictureNewModel enablePreviewAudio(boolean enablePreviewAudio) {
     ...
     * @return
     */
    public PictureNewModel freeStyleCropEnabled(boolean freeStyleCropEnabled) {
     ...
     * @return
     */
    public PictureNewModel scaleEnabled(boolean scaleEnabled) {
     ...
     * @return
     */
    public PictureNewModel rotateEnabled(boolean rotateEnabled) {
     ...
     * @return
     */
    public PictureNewModel circleDimmedLayer(boolean circleDimmedLayer) {
     ...
     * @return
     */
    public PictureNewModel showCropFrame(boolean showCropFrame) {
     ...
     * @return
     */
    public PictureNewModel showCropGrid(boolean showCropGrid) {
     ...
     * @return
     */
    public PictureNewModel hideBottomControls(boolean hideBottomControls) {
     ...
     * @return
     */
    public PictureNewModel withAspectRatio(int aspect_ratio_x, int aspect_ratio_y) {
     ...
     * @return
     */
    public PictureNewModel maxSelectNum(int maxSelectNum) {
     ...
     * @return
     */
    public PictureNewModel minSelectNum(int minSelectNum) {
     ...
     * @return
     */
    public PictureNewModel videoQuality(int videoQuality) {
     ...
     * @return
     */
    public PictureNewModel imageFormat(String suffixType) {
     ...
     * @return
     */
    public PictureNewModel cropWH(int cropWidth, int cropHeight) {
     ...
     * @return
     */
    public PictureNewModel videoMaxSecond(int videoMaxSecond) {
     ...
     * @return
     */
    public PictureNewModel videoMinSecond(int videoMinSecond) {
     ...
     * @return
     */
    public PictureNewModel recordVideoSecond(int recordVideoSecond) {
     ...
     * @return
     */
    public PictureNewModel glideOverride(@IntRange(from = 100) int width,
     ...
     * @return
     */
    public PictureNewModel sizeMultiplier(@FloatRange(from = 0.1f) float sizeMultiplier) {
     ...
     * @return
     */
    public PictureNewModel imageSpanCount(int imageSpanCount) {
     ...
     * @return
     */
    public PictureNewModel cropCompressQuality(int compressQuality) {
     ...
     * @return
     */
    public PictureNewModel compress(boolean isCompress) {
     ...
     * @return
     */
    public PictureNewModel synOrAsy(boolean synOrAsy) {
     ...
     * @return
     */
    public PictureNewModel compressSavePath(String path) {
     ...
     * @return
     */
    public PictureNewModel isZoomAnim(boolean zoomAnim) {
     ...
     * @return
     */
    public PictureNewModel previewEggs(boolean previewEggs) {
     ...
     * @return
     */
    public PictureNewModel isCamera(boolean isCamera) {
     ...
     * @return
     */
    public PictureNewModel setOutputCameraPath(String outputCameraPath) {
     ...
     * @return
     */
    public PictureNewModel isGif(boolean isGif) {
     ...
     * @return
     */
    public PictureNewModel previewImage(boolean enablePreview) {
     ...
     * @return
     */
    public PictureNewModel previewVideo(boolean enPreviewVideo) {
     ...
     * @return
     */
    public PictureNewModel openClickSound(boolean openClickSound) {
     ...
     */
    public PictureNewModel isDragFrame(boolean isDragFrame) {
     ...
     * @return
     */
    public PictureNewModel selectionMedia(List<LocalMedia> selectionMedia) {
    ...
    public void forResult(int requestCode) {
        if (!DoubleUtils.isFastDoubleClick()) {
            ...
            Intent intent = new Intent(activity, PictureNewActivity.class);
