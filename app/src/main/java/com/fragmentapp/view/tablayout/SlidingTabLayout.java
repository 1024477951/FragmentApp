package com.fragmentapp.view.tablayout;
...
import com.fragmentapp.view.tablayout.listener.OnTabSelectListener;
import com.fragmentapp.view.tablayout.utils.UnreadMsgUtils;
import com.fragmentapp.view.tablayout.widget.MsgView;
...
//        switch (position) {
//            case 0:
//                AndroidApplication.getInstance().getDataContactsBean().setTeam_hits(0);
//
//
//
//                break;
//            case 1:
//                AndroidApplication.getInstance().getDataContactsBean().setPost_hits(0);
//                break;
//            case 2:
//                AndroidApplication.getInstance().getDataContactsBean().setZhineng_hits(0);
//                break;
//            default:
//                break;
//        }
