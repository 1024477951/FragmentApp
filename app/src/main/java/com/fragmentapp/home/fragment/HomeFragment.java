...
public class HomeFragment extends LazyFragment {
    ...
    protected void init() {
        ...
        refreshLayout.setHeaderView(new DefHeaderView(getActivity()));
        refreshLayout.setHeaderView(headView);

        refreshLayout.setFootView(new DefFootView(getActivity()));

        refreshLayout.setCallBack(new RefreshLayout.CallBack() {
            @Override
